...
SYSTEM_PROMPT = (
    ...
    "- Asking to show, post or share the session code, what is playing, the "
    "queue, or the bot's status/health posts that info to the Discord "
    "channel: use session_info, now_playing, queue_info or status_info.\n"
