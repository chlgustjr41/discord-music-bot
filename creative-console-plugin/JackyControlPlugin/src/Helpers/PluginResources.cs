namespace Loupedeck.JackyControlPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.JackyControlPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.JackyControlPlugin.Resources.Resource.txt`.
